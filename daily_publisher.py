...
def generate_caption():
    ...
    prompt = (
        "Generate a short engaging social media caption for a construction time-lapse page. "
        "The video shows a building being constructed from foundation to completion in time-lapse. "
        "Include relevant hashtags. Keep it under 200 characters. "
        "Make it exciting and satisfying to watch."
    )
...
def get_fallback_caption():
    captions = [
        "From ground to sky in seconds #timelapse #construction #building",
        "Watch this building rise from nothing #constructiontimelapse #satisfying",
        "Foundation to finish in one video #timelapse #architecture #building",
        "The magic of construction #timelapse #construction #skyscraper",
        "Building dreams one frame at a time #construction #timelapse #amazing",
        "From empty lot to masterpiece #timelapse #construction #architecture",
        "Construction is art in motion #timelapse #building #engineering",
        "Rise and build #timelapse #construction #satisfyingvideos"
    ]
